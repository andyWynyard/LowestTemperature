...
public class LowestTemperature {
	public static void main (String[] args) throws Exception {
		...
		/*
		*	SD 2.	
		*	I searched for quite some time, but
		*	I was unable to find a suffiently formated
		*	txt file that had weather data that was 
		*	to my liking. There was just too much 
		* 	other data in the files, and I dont know 
		* 	as yet how to ignore and read from a specific
		* 	place.
		*
		*	It would be fairly simple I believe,
		*	as the URL would simply have to 
		*	be reworked a little. Could be wrong.
		*/
